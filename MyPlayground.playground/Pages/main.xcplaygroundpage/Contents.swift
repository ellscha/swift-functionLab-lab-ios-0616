 ...
 */
// write your code here
func helloToName(name: String){
    print("hello, \(name)")
    
}
helloToName("Jonathan")
helloToName("Naomi")
helloToName("Maeby")
...
// write your code here
func printPi(){
    let pi = 3.14159265358979323846264338327950288419716939937510582097494459230791640628620899862803482534211706798214808651
    print(pi)
}
